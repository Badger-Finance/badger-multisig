# https://github.com/balancer-labs/balpy/blob/a907f7b984f4e3ba3460a1ef064003d95da5e884/balpy/balancerv2cad/src/balancerv2cad/StableMath.py
...
class StableMath:
    ...
    @staticmethod
    def calcBptOutGivenExactTokensIn(pool, balances: list, amountsIn: list) -> Decimal:
    ...
    def calcTokensOutGivenExactBptIn(
        pool, balances: list, bptAmountIn: Decimal
    ) -> list:
        ...
        bptTotalSupply = pool.totalSupply()
    ...
    def calcTokenOutGivenExactBptIn(
        pool, balances: list, tokenIndex: int, bptAmountIn: Decimal
    ) -> Decimal:
