...
TOKEN = Contract(registry.eth.treasury_tokens.badgerWBTC_f)
POOL = Contract(registry.eth.crv_factory_pools.badgerWBTC_f)
...
def main():
    ...
    safe.take_snapshot(
        tokens=[BADGER, WBTC, TOKEN.address, bcrvIbBTC.address, crvIbBTC.address]
    )
