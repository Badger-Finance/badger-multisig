...
def main(
    ...
    badger_bribe_in_frax = int(badger_bribe_in_frax)
    ...
    # can leverage same interface for `depositBribeERC20` method
    frax_briber = interface.ITokenmakBribe(
        r.hidden_hand.frax_briber, owner=safe.account
    )
    ...
    if badger_bribe_in_balancer > 0:
        ...
        mantissa = int(Decimal(badger_bribe_in_balancer) * Decimal(1e18))
    ...
    if badger_bribe_in_convex > 0:
        ...
        mantissa = int(Decimal(badger_bribe_in_convex) * Decimal(1e18))
    ...
    if badger_bribe_in_frax > 0:
        ...
        mantissa = int(Decimal(badger_bribe_in_frax) * Decimal(1e18))
