...
def main():
    ...
    # badger emissions
    week_18_badger_emissions = Decimal(20_000e18)
    week_18_rembadger_emissions = Decimal(7692.307692e18)

    badger.transfer(tree, week_18_badger_emissions + week_18_rembadger_emissions)
